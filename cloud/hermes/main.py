#!/usr/bin/env python3
"""
Servicio hermes - DepaFix Cloud Native
"""
import os
...
app = FastAPI(title="DepaFix - hermes", version="1.0.0")
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "hermes", "timestamp": datetime.now().isoformat()}

@app.get("/")
def root():
    return {"service": "hermes", "status": "running", "version": "1.0.0"}
