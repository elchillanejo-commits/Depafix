#!/usr/bin/env python3
"""
Servicio aquiles - DepaFix Cloud Native
"""
import os
...
app = FastAPI(title="DepaFix - aquiles", version="1.0.0")
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "aquiles", "timestamp": datetime.now().isoformat()}

@app.get("/")
def root():
    return {"service": "aquiles", "status": "running", "version": "1.0.0"}
