...
# multi_dia.py hace lazy-import de core.db_manager/core.salud_agentes -- esos
# paquetes viven en la raiz del repo (DepaFix/core/), no junto a este script
# (DepaFix/04_MERCADO_PUBLICO/scraper/). Agregar la raiz al sys.path ANTES de
# importar multi_dia para que esos imports resuelvan sin depender de un
# CORE_PATH hardcodeado a una maquina especifica.
sys.path.insert(0, str(Path(__file__).resolve().parents[2]))

import multi_dia  # noqa: E402
