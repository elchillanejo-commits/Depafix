...
Flujo:
    ...
    2. precios_serviu y v_analisis_desviacion (ver
       sql/create_view_analisis_desviacion.sql) se leen en paralelo (hilos,
...
# el mismo mapeo en core/salud_agentes.py.
...
class SupabaseClientManager:
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            # ver sql/create_alertas_precio_serviu.sql y sql/create_salud_agentes.sql).
    ...
    def reportar_salud(self, estado: str, detalle: str, metricas: Optional[Dict[str, Any]] = None) -> None:
        ...
        fila = {
            ...
            # core/salud_agentes.py, mismo fix).
